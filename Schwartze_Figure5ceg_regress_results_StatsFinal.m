...
axis square
xlabel('Initial Depth of Mod. (Vel Adjusted)', 'Color', init_color)
ylabel('Corrective Depth of Mod. (Vel Adjusted)', 'Color', cor_color)
set(gca, 'FontSize', 14)
...
ylim([-0.1,90])
axis square
xlabel('Initial Depth of Mod.', 'Color', init_color)
ylabel('Corrective Depth of Mod.', 'Color', cor_color)
set(gca, 'FontSize', 14)
% set(gcf,'Position',[0 0 600 400]);
% title(['Monkey ' monkey])
