...
% % figure
% % plot (mean(squeeze(R2_tot(:,:,:)),2))
% % 
% % figure
% % plot (squeeze(R2_partial(1,1,:)),'DisplayName','position')
% % hold on
% % plot (squeeze(R2_partial(2,1,:)),'DisplayName','velocity')
% % plot (squeeze(R2_partial(3,1,:)), 'DisplayName','speed')
% % legend
% % hold off
% % 
% % %initial R-squared values
% % figure
% % plot (mean(squeeze(R2_tot_init(:,:,:)),2))
% % 
% % figure
% % plot (squeeze(R2_partial_init(1,1,:)),'DisplayName','position')
% % hold on
% % plot (squeeze(R2_partial_init(2,1,:)),'DisplayName','velocity')
% % plot (squeeze(R2_partial_init(3,1,:)),'DisplayName','speed')
% % legend
% % hold off
% % 
% % %corrective R-squared values
% % figure
% % plot (mean(squeeze(R2_tot_cor(:,:,:)),2))
% % 
% % figure
% % plot (squeeze(R2_partial_cor(1,1,:)),'DisplayName','position')
% % hold on
% % plot (squeeze(R2_partial_cor(2,1,:)),'DisplayName','velocity')
% % plot (squeeze(R2_partial_cor(3,1,:)),'DisplayName','speed')
% % legend
% % hold off
% 
% 
